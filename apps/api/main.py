...
from routers import analysis, data_preview, employee_requests, evg_override, health, legal_partner, partner, reports, root_cause, upload
...
app.include_router(legal_partner.router, prefix="/legal-partner")
