...
const SYSTEM_FIELDS = [
  { key: "first_name", label: "Imię", required: true },
  { key: "last_name", label: "Nazwisko", required: true },
...
const AUTO_DETECT_KEYWORDS: Record<string, string[]> = {
  ...
  hire_date: ["data zatrudnienia", "hire_date", "hire date", "data_zatrudnienia"],
  employment_type: ["typ umowy", "employment_type", "employment type", "umowa"],
};
          ...
          {SYSTEM_FIELDS.map(({ key, label, required }) => (
            <div key={key} className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={EMPTY_VALUE}>-- Wybierz --</SelectItem>
                  {csvColumns.map((col) => (
